...
import './ReviewMainPage.scss';

function ReviewMainPage(props) {
  const { item } = props;
  ...
  return (
    <li className="review">
      <img
        src={
          item.author.avatar
            ? `https://merlinsbeard.ru/${item.author.avatar}`
            : require('../../assets/images/defaultreview.png')
        }
        alt="author"
