    ...
    <div className="info-block">
        ...
        <div className="info-block__info">
          ...
          <div className="info-block__info-text">
            <h2 className="info-block__title">
              {blockOne.description.substring(0, blockOne.description.lastIndexOf(' '))}{' '}
              <span>{blockOne.description.split(' ').pop()}</span>
            </h2>
      ...
      {blockSecond && (
        <div className="info-block__info">
          <div className="info-block__info-text">
            <h2 className="info-block__title">
              {blockSecond.description.substring(0, blockSecond.description.lastIndexOf(' '))}{' '}
              <span>{blockSecond.description.split(' ').pop()}</span>
            </h2>
